function [objective_func] = specify_objective_function(time_vector, template, signal, measurement_window, polarity, weight_function, eval_function, normalize_function, penalty_function, use_derivative)
